...
{
    /// <summary>
    /// Debug utility that raises a firework request on key press.
    ...
    public class FireworkTestTrigger : MonoBehaviour
    {
        ...
        // ---- Serialized Fields ----
        [Header("Events")]
        [Tooltip("Firework request event to raise")]
        ...
        private void Update()
        {
            ...
            {
                if (_onFireworkRequested != null && _spawnPoint != null)
                {
                    PixelEntry[] pattern;
                    int patternWidth;
                    int patternHeight;
                    ...
                    _onFireworkRequested.Raise(new FireworkRequest
                    {
                ...
                {
                    Debug.LogWarning(
                        $"[{nameof(FireworkTestTrigger)}] Event or spawn point is not assigned.", this);
                }
            }
        }
